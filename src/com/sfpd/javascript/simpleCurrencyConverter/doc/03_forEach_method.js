...
/**
    As a result, console.log first shows the name "Mike", then "Alex", and finally,
    "Asya".
    ...
    necessary actions with the previous one.
    The method skips the elements that were deleted or not initialized.
