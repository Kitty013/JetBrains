...
/**
    Now, let's create an array by using the 6 slots and fill each one with the number
    2.
**/
...
$3. The from() method
    ...
    Let's look at some examples that demonstrate how to create an array with
    Array.from().
    Using a string:
**/
...
$4. The of() method
    ...
    instance containing the given arguments, regardless of their type or number. The
    syntax of the of() method is Array.of(element_1, element_2, ..., element_n).
