...
/**
    ...
    understands what's going on when you try to assign text to a variable:
**/
    let text = 'Hello, World!';

/**
    There we go! You can also use double quotes instead of single quotes, and
    backticks if the text contains multiple lines:
**/
...
$2. String length
    ...
    return 0. Here's a quick example:
**/
...
$3. Operations with strings
    ...
    strings using mathematical operators. However, the result of some of these
    operations may not be what you would expect. Here's a list of them:

        Summing two strings — this forms a new string by 'gluing' the original
        strings together. It's known as concatenation:
**/
        let mystring = 'Hello, ' + 'World!';
