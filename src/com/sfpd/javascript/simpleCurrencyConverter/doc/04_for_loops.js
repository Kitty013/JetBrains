...
/**
    ...
    Let's zoom in on the syntax of the for loop. We set a variable before the loop:
    the i counter. Next, the condition inside the brackets has three parts:
    (...;...;...). The initial value of the counter variable comes first; in our case,
    it equals 1. The second part is the condition in which the loop keeps working,
    which in our case is i <= 5. Finally, in the third part, we indicate how exactly
    the counter should change from one iteration to another. The i++ recording is the
    same as i = i + 1, that is, the counter ranges from 1 to 5 with the step of 1 at
    each iteration. Any part of the condition inside the brackets is optional and can
    be omitted.
**/
...
$1. Infinite loop
    ...
    condition for exiting the loop (the second condition in the brackets). To write
    an infinite loop, just skip the condition for exiting the loop to make a
